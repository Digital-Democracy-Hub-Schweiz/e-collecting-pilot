          ...
          <div className="grid gap-8">
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-1">
                ...
                <h3 className="text-lg font-semibold text-foreground">E-Collecting</h3>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-muted-foreground mb-4">
                      Laden Sie die <strong>swiyu</strong> App kostenlos im <a href="https://play.google.com/store/apps/details?id=ch.admin.foitt.swiyu&pcampaignid=web_share" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-700 underline">Google Play Store</a> oder <a href="https://apps.apple.com/ch/app/swiyu/id6737259614" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-700 underline">Apple Store</a> herunter.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="mt-4 space-y-2">
                      <a href="https://www.bcs.admin.ch/bcs-web/#/" target="_blank" rel="noopener noreferrer" className="block text-blue-600 hover:text-blue-700 underline">
                        Beta-ID erstellen und verifizieren
                      </a>
                      <a href="https://backend.eid.admin.ch/fileservice/sdweb-docs-prod-eidch-files/files/2025/03/25/509a3b49-1305-4838-be91-9985e3182adf.pdf" target="_blank" rel="noopener noreferrer" className="block text-blue-600 hover:text-blue-700 underline">
